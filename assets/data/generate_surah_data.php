...
for ($surahNumber = 1; $surahNumber <= 114; $surahNumber++) {
    ...
    if ($surahData && isset($surahData['data'])) {
        ...
        $allSurahData[$surahNumber] = $surahAyahs;
    } else {
        echo "Error fetching data for surah $surahNumber\n";
    }
}
$jsonData = json_encode($allSurahData, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES);
$file = 'surah_data.json';
